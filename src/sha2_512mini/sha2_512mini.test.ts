...
describe("SHA2_512MINI verification tests", () => {
  it("should accept a simple SHA2-512 hash", () => {
    ...
    const input = MRZWrapper.from(1n << 1023n, 0xcf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3en);
    hashVerify(input);
  });
})